...
const Timer: Component<TimerProps> = (props) => {
	...
	const [intervalId, setIntervalId] = createSignal<
	...
	const checkActiveTimer = async () => {
		try {
			...
			if (
				...
				(active && (!currentActive || active.id !== currentActive.id))
			) {
		...
		<div class="px-3 py-1 bg-base-100 backdrop-blur-sm" data-testid="timer">
			...
			<Show when={!isRunning() && recentTasks().length > 0}>
				<div
					...
					data-testid="timer-recent-tasks"
				>
