...
const TitleBar: Component = () => {
  ...
  return (
    <div class="flex items-center justify-between h-8 bg-base-100 border-b border-base-300 select-none">
      ...
      <div class="flex items-center gap-2 px-3 flex-1" style="-webkit-app-region: drag">
        ...
        {/* App Name */}
        <span class="text-sm font-semibold text-base-content">Chronii</span>
      </div>
